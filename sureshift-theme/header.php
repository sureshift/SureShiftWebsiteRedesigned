...
<?php endif; ?>
<link rel="icon" href="https://sureshift.in/wp-content/uploads/2026/08/logoSureshift-scaled.png" type="image/png">
<link rel="apple-touch-icon" href="https://sureshift.in/wp-content/uploads/2026/08/logoSureshift-scaled.png">
<?php wp_head(); ?>
</head>
<body <?php body_class(); ?>>
<?php wp_body_open(); ?>
  ...
  <div class="nav-wrap">
    ...
    <nav class="nav-menu" aria-label="Primary navigation">
      ...
      <a href="<?php echo esc_url(home_url('/pay-online/')); ?>" class="nav-pay">
        <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" aria-hidden="true"><rect x="1" y="4" width="22" height="16" rx="2"/><line x1="1" y1="10" x2="23" y2="10"/></svg>
        Pay Online
      </a>
...
<nav class="nav-panel" id="navPanel" aria-hidden="true" aria-label="Mobile navigation">
  <div class="nav-panel-head">
    <img src="https://sureshift.in/wp-content/uploads/2026/08/logoSureshift-scaled.png" alt="Sure Shift" height="28">
